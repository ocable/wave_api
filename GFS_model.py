...
def parse_GFS_model(bull_file):
    ...
    def _calc_energy(height_str, period_str):
        h = _to_float(height_str)
        p = _to_float(period_str)
        if h is None or p is None:
            return None
        return wave_energy(p, h)
        ...
        for i in range(7, len(raw_data) - 9):
            ...
            if len(first_line) == 4:
                ...
                dict = { 
                    ...
                    "num_swell_components": num_swell_components
                }
                ...
                comp1_energy = _calc_energy(comp1_height, comp1_period)
                ...
                dict = { 
                    ...
                    "comp1_period": comp1_period,
                    "comp1_dir": comp1_dir,
                    "comp1_energy": comp1_energy
                }
                ...
                # Energy calculations
                comp1_energy = _calc_energy(comp1_height, comp1_period)
                comp2_energy = _calc_energy(comp2_height, comp2_period)
                ...
                dict = { 
                    ...
                    "comp2_period": comp2_period,
                    "comp2_dir": comp2_dir,
                    "comp2_energy": comp2_energy
                }
                ...
                comp1_energy = _calc_energy(comp1_height, comp1_period)
                comp2_energy = _calc_energy(comp2_height, comp2_period)
                comp3_energy = _calc_energy(comp3_height, comp3_period)
                ...
                dict = { 
                    ...
                    "comp3_period": comp3_period,
                    "comp3_dir": comp3_dir,
                    "comp3_energy": comp3_energy
                }
